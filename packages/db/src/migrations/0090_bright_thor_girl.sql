...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "crewbrief_aircraft" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"type" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "crewbrief_airports" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"icao" text NOT NULL,
	"iata" text,
	"name" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "crewbrief_crew_members" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "crewbrief_duty_days" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "crewbrief_legs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"trip_id" text NOT NULL,
	"duty_day_id" text,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "crewbrief_trips" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"trip_id" text NOT NULL,
	"airline" text,
	"status" text DEFAULT 'scheduled' NOT NULL,
...
ALTER TABLE "issues" ADD COLUMN IF NOT EXISTS "productivity_review_snoozed_until" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "company_secret_bindings" DROP CONSTRAINT IF EXISTS "company_secret_bindings_company_id_companies_id_fk";
...
ALTER TABLE "company_secret_bindings" DROP CONSTRAINT IF EXISTS "company_secret_bindings_secret_id_company_secrets_id_fk";
...
ALTER TABLE "company_secret_provider_configs" DROP CONSTRAINT IF EXISTS "company_secret_provider_configs_company_id_companies_id_fk";
...
ALTER TABLE "company_secret_provider_configs" DROP CONSTRAINT IF EXISTS "company_secret_provider_configs_created_by_agent_id_agents_id_fk";
...
ALTER TABLE "crewbrief_email_log" DROP CONSTRAINT IF EXISTS "crewbrief_email_log_waitlist_entry_id_crewbrief_waitlist_entries_id_fk";
...
ALTER TABLE "crewbrief_referrals" DROP CONSTRAINT IF EXISTS "crewbrief_referrals_referrer_id_crewbrief_waitlist_entries_id_fk";
...
ALTER TABLE "crewbrief_referrals" DROP CONSTRAINT IF EXISTS "crewbrief_referrals_referee_id_crewbrief_waitlist_entries_id_fk";
...
ALTER TABLE "issue_recovery_actions" DROP CONSTRAINT IF EXISTS "issue_recovery_actions_company_id_companies_id_fk";
...
ALTER TABLE "issue_recovery_actions" DROP CONSTRAINT IF EXISTS "issue_recovery_actions_source_issue_id_issues_id_fk";
...
ALTER TABLE "issue_recovery_actions" DROP CONSTRAINT IF EXISTS "issue_recovery_actions_recovery_issue_id_issues_id_fk";
...
ALTER TABLE "issue_recovery_actions" DROP CONSTRAINT IF EXISTS "issue_recovery_actions_owner_agent_id_agents_id_fk";
...
ALTER TABLE "issue_recovery_actions" DROP CONSTRAINT IF EXISTS "issue_recovery_actions_previous_owner_agent_id_agents_id_fk";
...
ALTER TABLE "issue_recovery_actions" DROP CONSTRAINT IF EXISTS "issue_recovery_actions_return_owner_agent_id_agents_id_fk";
...
ALTER TABLE "secret_access_events" DROP CONSTRAINT IF EXISTS "secret_access_events_company_id_companies_id_fk";
...
ALTER TABLE "secret_access_events" DROP CONSTRAINT IF EXISTS "secret_access_events_secret_id_company_secrets_id_fk";
...
ALTER TABLE "secret_access_events" DROP CONSTRAINT IF EXISTS "secret_access_events_plugin_id_plugins_id_fk";
...
CREATE INDEX IF NOT EXISTS "cb_email_email_idx" ON "crewbrief_email_log" USING btree ("email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cb_email_template_idx" ON "crewbrief_email_log" USING btree ("template_name","email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cb_hs_entity_idx" ON "crewbrief_hubspot_sync" USING btree ("entity_type","entity_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cb_hs_hubspot_idx" ON "crewbrief_hubspot_sync" USING btree ("hubspot_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cb_ref_referrer_idx" ON "crewbrief_referrals" USING btree ("referrer_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cb_ref_referee_email_idx" ON "crewbrief_referrals" USING btree ("referee_email");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "cb_waitlist_email_idx" ON "crewbrief_waitlist_entries" USING btree ("email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "cb_waitlist_status_idx" ON "crewbrief_waitlist_entries" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "cb_waitlist_ref_code_idx" ON "crewbrief_waitlist_entries" USING btree ("referral_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "issue_recovery_actions_active_fingerprint_uq" ON "issue_recovery_actions" USING btree ("company_id","source_issue_id","cause","fingerprint") WHERE "issue_recovery_actions"."status" in ('active', 'escalated');--> statement-breakpoint
...
ALTER TABLE "company_secrets" DROP CONSTRAINT IF EXISTS "company_secrets_provider_config_id_company_secret_provider_configs_id_fk";
